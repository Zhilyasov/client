...
const Header = () => {
    ...
    useEffect(() => {
        if(openBurger) {
            ...
            headerTimeout = setTimeout(() => { setHeaderFixed(false) }, 400);
        }
    }, [openBurger])

    return (
        <>
            {headerFixed ? <div style={{ height: "80px" }}> </div> : null} 
            <div style={{ right: !openBurger ? "-160%": "0px" }}
                className={`${styles.container} ${
                    headerFixed ? styles.active : "unset"
                }`}
            >
                <Link to="/">
                    <img style={{ opacity: !openBurger && headerFixed ? "0" : "1" }} src={Logo} alt="logo" className={styles.logo} />
                </Link>
                <div
                    className={`${styles.burger} ${
                        openBurger ? styles.active : ""
                    }`}
                ...
                <div className={styles.block}>
                    <a
                        href="https://whitepaper.niseapp.org"
                        target="_blank"
            ...
            >
                ...
                >
                    ...
                    />
                    <p className={styles.iconText}>Whitepaper</p>
                </a>
                <a
                    href="https://t.me/niseapp"
                    target="_blank"
                ...
                >
                    <img
                        ...
                        className={styles.iconMobile}
                    />
                    <p className={styles.iconText}>YouTube</p>
                </a>
                <a
                    href="https://x.com/NiseApp"
                    target="_blank"
                ...
                />
                <img src={Flower} alt="flower" className={styles.flower4} />
                <img src={Flower} alt="flower" className={styles.flower5} />
                <img src={Flower} alt="flower" className={styles.flower6} />
            </div>
        </>
    )
}
